...
def test_kupiec(excepciones: int, n_observaciones: int, nivel_confianza: float) -> dict:
    ...
    Soporta matemáticamente los límites de 0 y N excepciones de forma de evitar divisiones por cero y log(0).
    """
    ...
    # Usamos el límite de L'Hôpital: lim_{x->0} x * ln(x) = 0
    term_1_null = (n - x) == 0
    term_2_null = x == 0
